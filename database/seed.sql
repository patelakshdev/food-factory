...
INSERT IGNORE INTO categories (name, slug, display_order, status) VALUES
...
INSERT IGNORE INTO menu_items (category_id, name, slug, description, price, image, is_veg, status) VALUES
...
INSERT IGNORE INTO item_variants (menu_item_id, name, price_delta, is_default) VALUES
...
INSERT IGNORE INTO addons (menu_item_id, name, price) VALUES
...
INSERT IGNORE INTO restaurant_tables (label, capacity) VALUES
...
INSERT IGNORE INTO coupons (code, type, value, min_order, max_discount, usage_limit, per_user_limit, first_order_only, status)
